...
description: Marco Volino researches and consults across computer vision, graphics and machine learning for digital humans, volumetric video, neural rendering and immersive media.
...
<div class="container" id="bio">
	...
	<div id="bio_text">
		...
		<p>
			Marco also offers consultancy across computer vision, computer graphics and machine learning, particularly for organisations working on visual media production, digital humans, volumetric video, neural rendering, virtual production, immersive technology and AI-enabled creative tools.
		</p>
		<p>
		...
		<div class="homepage-actions">
			...
			<a class="btn btn-primary btn-sm" href="{{ '/#consultancy' | relative_url }}">Consultancy</a>
		</div>
	</div>
</div>
...
<div class="container">
	<p>
		Marco offers consultancy across computer vision, computer graphics and machine learning, with a focus on translating research into practical tools and workflows for the creative and technology sectors.
	</p>
	<p>
		Areas include technical feasibility and research scoping, prototype design and evaluation, computer vision and graphics pipelines, machine learning for visual media, volumetric video, digital humans, neural rendering, R&amp;D strategy, grant support and academic-industry collaboration.
	</p>
</div>
